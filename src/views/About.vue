        ...
        <div class="container-right" v-bind:class="{ back: isPrevious }">
            <div class="content-container">
                ...
                <p class="text" v-if="isShown">
                    ...
                    to learn German. After finishing high school this summer, I
                    decided to start learning the basics of web development.
                    After a few months and a couple of projects, I'm looking for
                    a job in this field either as an intern or a junior
                    developer.
                </p>
                <p class="text" v-if="isShown">
                    In my free time (when I'm not learning anything) I like to
                    watch TV shows or hang out with my friends. I'm quite a big
                    fan of Formula 1 so every weekend is spent watching races
                    and following news around this great sport. To stay in
                    shape, I try to run at least three times a week to stay
                    healthy and clear my head.
                </p>
            </div>
